...
## 현재 상태
- **단계**: 세인 weekly 20건 / 혜인 5건 = 각 1000p. QuestCard 좌측을 명확한 체크박스로 개선. 메탈카드봇에 SSG 이미지 표시.
- **마지막 작업**: 2026-04-25 · 1) 영어학원 4/20→4/27 이동 + 점수 재배분 2) QuestCard 체크박스 UX 개선 3) Reward.image_url 도입.
- **다음 할 일**: 매주 토요일 — 눈높이 + 영어학원 주간 숙제 재배포.
